...
import com.hugopinto.segundoparcial.Activities.MainActivity;
 ...
 * {@link JuegosFragment.OnFragmentInteractionListener} interface
...
public class JuegosFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv = v.findViewById(R.id.recyclerjuegos);
        ...
        nvmodel.getGames().observe(this, new Observer<List<String>>() {
            ...
            public void onChanged(@Nullable List<String> news) {
                adapter = new JuegosAdapter((ArrayList<String>) news,getActivity()){
                    @Override
                    public void up(String nt){
                        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.contenido, GenericFragment.newInstance(nt)).commit();
